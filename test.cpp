...
void *SAT_Vertexcover(void *arg)
{
    ...
    pclock("SAT RUNNING TIME (ns): ", CLOCK_THREAD_CPUTIME_ID);
    return ((void *)0);
}
...
void *Approx_vc_1(void *arg)
{
    ...
    cout << rtn.str() << endl;
    pclock("VC_1 RUNNING TIME (ns): ", CLOCK_THREAD_CPUTIME_ID);
    return ((void *)0);
}
...
void *Approx_vc_2(void *arg)
{
    ...
    cout << rtn.str() << endl;
    pclock("VC_2 RUNNING TIME (ns): ", CLOCK_THREAD_CPUTIME_ID);
    return ((void *)0);
}